...
```{r echo = FALSE, eval = TRUE, message=FALSE, include = FALSE, fig.width = 10, fig.height = 6}

TASA15<-readRDS("TASA15.rds")
  glimpse(TASA15)
  
ggplot(TASA15, aes(x=reorder(Entidad, Tasa), y=Tasa,colour=Sexo, size=Tasa))+
geom_point()+
theme_bw()+
...
ggsave("Tasa_mor_15_rinitis15.tiff", width = 21, height = 16, units = "cm",dpi=300)
